    ...
    <body>
        ...
        <div class="row" style="margin-bottom: 10px">
            ...
            <div class="col-md-3 text-right">
                <form action="<?php echo site_url('blog/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('blog'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
		...
		<th>Action</th>
			...
			<td><?php echo $blog->LINK_MATERI ?></td>
